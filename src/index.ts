...
const playerIds_tracked = [
  4008, 42092, 45899, 186338, 74829, 144393, 366274, 378113, 426378, 484129,
  486906, 494352, 498963, 504586, 504610, 558168, 583429, 490463, 518674,
  500126,
];
...
async function main() {
  ...
  for (const player of players) {
    ...
    content += `<tr><th><a href="https://www.elevenvr.net/eleven/${
      player.id
